...
function Footer() {
  ...
  shadow-[0_25px_60px_rgba(0,0,0,0.7)]'>
    <div className='grid grid-cols-1 md:grid-cols-3 gap-8 items-start'>
        ...
        whileHover={{ rotateX: 6, rotateY: -6 }}
          ...
          PrepGenius{" "}
          <span className="bg-gradient-to-br from-violet-700 to-red-400 bg-clip-text text-transparent">
            AI
          </span>
    </span>
 ...
 <div className='text-center'>
            ...
            <ul className='space-y-2 text-sm'>
                ...
                <li className='text-gray-300 hover:text-white transition-colors'>support@prepgenius.com</li>
            </ul>
        </div>
     ...
     <p className='text-center text-xs text-gray-500'>
        © {new Date().getFullYear()} PrepGenius AI. All rights reserved.
     </p>
